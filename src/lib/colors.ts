 ...
 *
 * Some catalog systems store color values in `value.value` as hex.
 ...
 * Used as fallback when attributes don't have hex values.
 */
...
/**
 * Get hex color from an attribute value.
 *
 * Priority:
 ...
 *
 * @param value - The attribute value from the catalog
