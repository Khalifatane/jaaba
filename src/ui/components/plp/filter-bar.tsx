					...
					<div className="flex shrink-0 items-center gap-3">
						...
						<DropdownMenu>
							...
							<DropdownMenuContent align="end" className="w-48">
								...
								>
									<DropdownMenuRadioItem value="featured">À la une</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="newest">Les plus récents</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="price_asc">Prix : croissant</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="price_desc">Prix : décroissant</DropdownMenuRadioItem>
									<DropdownMenuRadioItem value="bestselling">Meilleures ventes</DropdownMenuRadioItem>
								</DropdownMenuRadioGroup>
							</DropdownMenuContent>
						</DropdownMenu>
					</div>
					...
					<div className="scrollbar-hide -mx-1 mt-3 flex items-center gap-2 overflow-x-auto px-1 py-1">
						{activeFilters.map((filter) => (
							...
							>
								...
								>
									<X className="h-3 w-3" />
									<span className="sr-only">Supprimer le filtre {filter.value}</span>
								</button>
							</Badge>
						))}
								<Button
