	...
	return (
		<Accordion type="multiple" defaultValue={["description"]} className="w-full">
			...
			<AccordionItemWithContext value="shipping" className="border-border">
				...
				<AccordionContent className="leading-relaxed text-muted-foreground">
					<p className="mb-2">Livraison gratuite pour les commandes supérieures à €100. Livraison standard 3-5 jours ouvrables.</p>
					<p>Retours gratuits sous 30 jours après l'achat. Les articles doivent être non portés et avec les étiquettes attachées.</p>
				</AccordionContent>
			</AccordionItemWithContext>
		</Accordion>
	);
