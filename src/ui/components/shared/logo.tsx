...
/**
 * Storefront logo (100x23, aspect ratio ~4.35:1)
 ...
 */
export const Logo = ({ className, ariaLabel = "Storefront", inverted = false }: LogoProps) => {
	// When inverted, swap the light/dark mode logic
	const lightModeLogo = inverted ? "/logo-dark.png" : "/logo.png";
	const darkModeLogo = inverted ? "/logo.png" : "/logo-dark.png";
